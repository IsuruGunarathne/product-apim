...
/**
 * Integration tests for SSRF protection with the feature disabled (no config block present).
 */
public class SSRFDisabledTestCase extends APIMIntegrationBaseTest {
    ...
    public void setEnvironment() throws Exception {
        ...
        APIRequest apiRequest = new APIRequest("SSRFDisabledTestAPI", "/ssrfdisabled",
    ...
    @Test(groups = {"wso2.am"},
            description = "SSRF [feature disabled]: all platform checks skipped, nothing blocked")
    public void testSSRFDisabled_NothingBlocked() throws Exception {
