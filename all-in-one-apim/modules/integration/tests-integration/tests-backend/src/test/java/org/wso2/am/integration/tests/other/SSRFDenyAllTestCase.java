...
/**
 * Integration tests for SSRF protection with deny_all mode and bpna=true.
 */
public class SSRFDenyAllTestCase extends APIMIntegrationBaseTest {
    ...
    public void setEnvironment() throws Exception {
        ...
        APIRequest apiRequest = new APIRequest("SSRFDenyAllTestAPI", "/ssrfdenyall",
    ...
    @Test(groups = {"wso2.am"},
            description = "SSRF [deny_all+bpna=true]: all URLs blocked; platform deny_all overrides tenant allowlist")
