...
/**
 * Integration tests for SSRF protection with platform-level allow mode (NetworkSecurityAccessControl).
 */
public class SSRFAllowModeTestCase extends APIMIntegrationBaseTest {
    ...
    @Test(groups = {"wso2.am"},
            description = "SSRF [allow mode]: non-platform-listed URL is blocked by platform allow mode")
    ...
    @Test(groups = {"wso2.am"},
            description = "SSRF [allow mode]: private IP URL is blocked by platform allow mode",
    ...
    @Test(groups = {"wso2.am"},
            description = "SSRF [allow mode]: platform allow mode overrides tenant-level allow mode config",
